...
export class ResultPageComponent implements OnInit {
  ...
  constructor(private dataExchangeService: DataExchangeService, private translate: TranslateService) { }
  ...
  calculateQuestionnaireAverages() {
    let questionnaireAverageValues: number[] = [];

    this.questionnaire.cattells16Questions
  }
